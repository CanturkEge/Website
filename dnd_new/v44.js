    ...
    return `<section class="v44-page">
      ...
      <div class="v44-generator-layout">
        <section class="card v44-generator-controls">
          ...
          <details class="v44-odds"><summary>Nadirlik ve kaliteli ödül garantisi</summary><p>Gerçek sandık, kasa, zula ve yaratık ini artık yalnız para vermez. İlk eşya çöp/belge değildir ve kaliteye göre asgari nadirlik taşır:</p><ul><li><b>Yıpranmış:</b> en az Yaygın</li><li><b>Standart:</b> en az Seyrek; 7+ seviyede Nadir</li><li><b>Zengin:</b> en az Nadir; 8+ seviyede Çok Nadir</li><li><b>Efsane Hazinesi:</b> en az Çok Nadir; 9+ seviyede Efsanevi</li></ul><p>Diğer eşyalarda seviye ve kalite ağırlıklı zar sürer. Ayrıca her atıştan önce Artefakt için 1 / 100.000.000 ve Efsanevi sürpriz için sonraki 1 / 10.000.000 uç ihtimal korunur.</p></details>
        </section>
