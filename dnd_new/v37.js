...
const V37_PATCH_NOTES=[
  {
    version:'3.3.1',build:'Build 73',title:'Tam Genişlik DM Savaş Masası',tag:'SAVAŞ',tone:'current',
    summary:'Taktik savaş ekranı paneli bütünüyle dolduruyor; savaşçı ayrıntıları daha okunabilir ve erişilebilir tek yerde yönetiliyor.',
    added:['DM savaşçı listesi, odak kaybetmeyen yaratık araması ve doğrudan boş kareye ekleme düğmeleri.','Tahta için cihaz yerel zoom kontrolleri ve pointer tabanlı token sürükleme.','Seçilen savaşçı için X/Y koordinatı, can, sıra, hız, görüş, görünüm ve saldırı grupları.','Oyuncunun kendi tokenını sıra şeridinden seçebilmesi.'],
    fixed:['İç içe main elemanının ve sol paletin savaş tahtasını gereksiz daraltması giderildi.','Tahta, token, obje ve sis katmanları birlikte ölçeklenerek panelde boş alan bırakması engellendi.','Tokenın tahta dışına sürüklenince kaybolması ve yaratık aramasında her harfte odağın düşmesi engellendi.'],
    changed:['DM paleti ile savaşçı detayları masaüstünde üstte yan yana, savaş alanı altta tam genişlikte gösterilir; mobilde tahta önceliklidir.','Tıklanabilir alanlar ve detay metinleri büyütüldü; oyuncu HTML çıktısında DM kontrolleri üretilmez.','Mevcut Supabase state, realtime ve battle_token_move_v60 yetki akışı değiştirilmedi.']
  },
  {
...
function v37PatchPage(){
  ...
  <section class="v37-patch-page">
    <div class="v37-patch-hero">
      <div><span class="v26-kicker">KADİM MASA DEFTERİ</span><h2>v3.3.1 • Build 73</h2><p>Tam genişlik savaş masası ve okunabilir, erişilebilir savaşçı detay yönetimi.</p></div>
    ...
    <p class="v37-version-note">v0.1.0–v3.3.1 oyuncuya açık kilometre taşı numaralarıdır. Düzeltme patch'i, yeni sistem minor'ı, büyük deneyim değişimi major'ı artırır; segmentler 9’dan sonra 10 diye devam edebilir. “Build” etiketi dağıtılan teknik pakettir.</p>
