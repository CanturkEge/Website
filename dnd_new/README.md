...
- Ürün sürümü: **2.8.1**
- Build/modül sürümü: **v60 / Build 60**
- Son paket: yaratık ansiklopedisi düzeltmesi ve güvenli oyuncu savaş hareketi
...
4. Güncel kurulum için `v53-update.sql`, `v56-update.sql`, `v59-update.sql`, `v60-update.sql`, `livekit-token` ve `kadim-admin` Edge Function'larını kontrol et.
